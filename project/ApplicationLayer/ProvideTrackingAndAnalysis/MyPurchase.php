...
$data = $track->viewHistory($cus_id);
$datacheck = $track->checkHistory($cus_id);
...
<body bgcolor="#ffcccc">
  <table id="top" height="9%" width="100%">
    ...
    <tr>
      <td></td>
      <td colspan="2" align="center"> <a href="../ManageUser/CustomerHomepage.php" style="margin-right: 40px">Home</a> <a href="../ManagePayment/ViewCart.php" style="margin-right: 40px">My Cart</a> <a href="MyPurchase.php" style="margin-right: 40px">My Purchase</a> <a href="TrackOrder.php" style="margin-right: 40px">Track Order</a></td>
  ...
  <table id="scd_detail" width="70%" height="70%" align="center" rules="all">
    ...
    <?php
      if($datacheck == 0){
        echo "<tr>
        <td colspan='5' align='center'> <h1>No complete yet</h1></td>
        </tr>
        </table>";
      }
      else{
