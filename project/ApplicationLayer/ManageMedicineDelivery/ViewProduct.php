...
if(isset($_POST['getData'])){
  $output = $med->med_viewVariation();
  echo $output;
  exit;
}

$med_variationn = $_GET['med_variation'];

if($med_variationn == "Vitamin"){
  $name = "Vitamin";
}
else if($med_variationn == "Personal"){
  $name = "Personal Care";
}
else if($med_variationn == "Food"){
  $name = "Health Food";
}
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
    var variation = "<?php echo $_GET['med_variation']?>";
