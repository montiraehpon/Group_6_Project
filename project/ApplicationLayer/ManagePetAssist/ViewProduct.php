...
if(isset($_POST['getData'])){
  $output = $pet->pet_viewVariation();
  echo $output;
  exit;
}

$pet_variationn = $_GET['pet_variation'];

if($pet_variationn == "Food"){
  $name = "Pet Food";
}
else if($pet_variationn == "Toy"){
  $name = "Pet Toy";
}
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
    var variation = "<?php echo $_GET['pet_variation']?>";
